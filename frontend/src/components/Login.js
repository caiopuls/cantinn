      ...
      border border-red-200 bg-red-100">{error}</div>}
        ...
        <div id="email" className="w-full border px-2 mt-3 border-gray-200">
                <div className="p-1 pt-3 flex items-center">
                    ...
                    <p className="text-xl pl-3">Seu email de conta existente</p>
                </div>
                
                <input type="email" ref={emailRef} required className="px-10 outline-none w-full pb-3" placeholder="Insira seu email" />
            </div>
            ...
            <div id="password" className="w-full border px-2 mt-3 border-gray-200">
                <div className="p-1 pt-3 flex items-center">
                    ...
                    <p className="text-xl pl-3">Insira sua senha de acesso</p>
                </div>
                
                <input type="password" ref={passwordRef} className="px-10 outline-none w-full pb-3" placeholder="Insira sua senha de acesso segura" />
            </div>
            ...
            <button disabled={loading} type="submit" className="btn-blue mt-3">Entrar na conta</button>
            </div>
          </form>
    </div>
  )
